...
from component import nel_wikidata_lookup, version
...
if len(SERVER_PORT) > 0:
    ...
    URL_COMPONENT = f"{SERVER_HOST}"
logging.info(f"URL_COMPONENT: {URL_COMPONENT}")
...
app.include_router(nel_wikidata_lookup.router)
